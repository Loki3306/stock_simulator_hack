        ...
        <div className="lg:col-span-2 rounded-xl border border-border/60 bg-card/60 p-5">
          ...
          <div className="mt-4 grid gap-4 sm:grid-cols-2">
            {[
              ...
              <div
                key={i}
                className="rounded-lg border border-border/60 bg-card-gradient p-4"
              >
                <div className="flex items-center justify-between">
                  <div>
                ...
                <div className="mt-3 flex gap-2">
                  <a
                    href="/builder"
                    className="px-3 py-1.5 text-xs rounded-md border border-white/15"
                  >
                    Edit
                  </a>
                  <a
                    href="/backtest/mock"
                    className="px-3 py-1.5 text-xs rounded-md btn-gradient text-black"
                  >
                    Run Backtest
                  </a>
                </div>
        ...
        <div className="grid gap-6">
          <div className="rounded-xl border border-border/60 bg-card/60 p-5">
            ...
            <div className="mt-4 grid gap-4">
              {Object.entries(market).map(([sym, data]) => (
                <div
                  key={sym}
                  className="rounded-lg border border-border/60 bg-card-gradient p-3"
                >
          ...
          <div className="rounded-xl border border-border/60 bg-card/60 p-5">
            ...
            <div className="mt-4 grid gap-3">
              <a
                href="/builder"
                className="px-4 py-2 rounded-md btn-gradient text-black font-medium text-center"
              >
                Create New Strategy
              </a>
              <button className="px-4 py-2 rounded-md bg-white/5 border border-white/10 text-sm hover:bg-white/10 transition">
                Import Template
              </button>
              <button className="px-4 py-2 rounded-md bg-white/5 border border-white/10 text-sm hover:bg-white/10 transition">
                Run Backtest
